DZK312's Fanciful Resources Mod: 1.4.0
Reskins basic resources and other items into prettier, more fitting, or more realistic ones

<< REQUIREMENTS >>
• Stardew Valley 1.6
• SMAPI 4.0.8
• Content Patcher 2.1.2
• Content Patcher Animations (Optional)

<< FEATURES >>
• Reskins most resources, animal goods, and the occasional key item
...
• In the config.json, write or delete the names of the items you do or don't want to use the reskinned
  ...
  • "Organics" Default: "Fertilizer, Cave, Tea, Seeds, Mushrooms, Taps, Shells, Trash, Key"
  • "Misc" Default: "Food, Tonics, Bombs, Battery, Trash, Quest, Special"
...
• Note that if Mushrooms are reskinned, the Magma Cap (Enemy) is also reskinned accordingly
